...
const SHOPPING_CENTERS = [
  ...
  { id: 'sc-2', name: 'Aréna Mall', address: 'Budapest, Örs vezér tere 25/A, 1106', lat: 47.513, lng: 19.1375, capacity: 1200, occupied: 890, openingHours: '08:00 - 21:00', description: 'Modern shopping mall with extensive parking facilities', imageUrl: '/images/arena.webp' },
  { id: 'sc-3', name: 'Allee', address: 'Budapest, Október 23. utca 8-10, 1117', lat: 47.4756, lng: 19.0483, capacity: 600, occupied: 425, openingHours: '09:00 - 21:00', description: 'Popular shopping destination in Buda side', imageUrl: '/images/allee.webp' },
  ...
  { id: 'sc-7', name: 'Shopmark', address: 'Budapest, Üllői út 201, 1191', lat: 47.45, lng: 19.135, capacity: 500, occupied: 220, openingHours: '08:00 - 21:00', description: 'Compact shopping center with easy parking access', imageUrl: '/images/shopmark.webp' },
];
